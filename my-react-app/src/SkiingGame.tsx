...
const hillTileImages = import.meta.glob('website-resume/my-react-app/src/assets/SledRacing/HillTiles/*.png', { eager: true, as: 'url' });
const penguinAssets = import.meta.glob('website-resume/my-react-app/src/assets/SledRacing/Penguin/*.png', { eager: true, as: 'url' });
const tubeAssets = import.meta.glob('website-resume/my-react-app/src/assets/SledRacing/Tube/*.png', { eager: true, as: 'url' });
const otherAssets = import.meta.glob('website-resume/my-react-app/src/assets/SledRacing/*.png', { eager: true, as: 'url' });
